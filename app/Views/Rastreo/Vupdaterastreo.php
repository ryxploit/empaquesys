                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" value="<?php echo $dato[0]['fecha'];?>" name="fecha"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $dato[0]['sello'];?>" name="sello"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $dato[0]['destino'];?>" name="destino"
                                    class="form-control">
                            </div>
                            <div class="form-group">
