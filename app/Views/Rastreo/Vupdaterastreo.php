                          ...
                          <h6 class="text-white">Codigo</h6>
                                  <fieldset class="form-group">
                                      <select name="codigo" class="form-select" >
                                        <option value="<?php echo $dato[0]['codigo'];?>"><?php echo $dato[0]['codigo'];?></option>
                                        <?php foreach ($listarpedidos as $key): ?>
                                          <option value="<?php echo $key->codigo_embarque;?>"><?php echo $key->codigo_embarque;?></option>
                                          <?php endforeach; ?>
                                      </select>
                                  </fieldset>
                        </div>
                            ...
                            <h6 class="text-white">Capuchon</h6>
                                    <fieldset class="form-group">
                                        <select name="capuchon" class="form-select" >
                                            <option value="<?php echo $dato[0]['capuchon'];?>"><?php echo $dato[0]['capuchon'];?></option>
                                            <option>negro</option>
                            ...
                            <h6 class="text-white">Fondo</h6>
                                    <fieldset class="form-group">
                                        <select name="fondo" class="form-select">
                                            <option value="<?php echo $dato[0]['fondo'];?>"><?php echo $dato[0]['fondo'];?></option>
                                            <option>negro</option>
                                            <option>blanco</option>
                                            <option>convinado</option>
                                        </select>
                                    </fieldset>
                          </div>
                      </div>
                          ...
                          <h6 class="text-white" >Malla</h6>
                                  <fieldset class="form-group">
                                      <select name="malla" class="form-select" >
                                          <option value="<?php echo $dato[0]['malla'];?>"><?php echo $dato[0]['malla'];?></option>
                                          <option>si</option>
                                          <option>No</option>
                                          <option>base</option>
                                      </select>
                          ...
                          <h6 class="text-white">Termografo</h6>
                                  <fieldset class="form-group">
                                      <select name="termografo" class="form-select" >
                                            <option value="<?php echo $dato[0]['termografo'];?>"><?php echo $dato[0]['termografo'];?></option>
                                          <option>si</option>
                                          <option>no</option>
                                      </select>
                                  </fieldset>
