        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <fieldset class="form-group">
                <select name="termografo_pallet" class="form-select">
                  <option>SI</option>
                  <option>NO</option>
                </select>
              </fieldset>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $key->hidrotermico;?></td>
                <td><?php echo $key->termografo_pallet;?></td>
              <td>
    ...
    <div class="card border-primary  ">
      ...
      <div class="card-body">
        ...
        <div class="row p-3">
          ...
          <div class="card text-dark bg-warning  col-5 mx-3 " style="width: 15rem;height:17rem;">
            <div class="card-body">
