                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($key->status_embarque == 'enviado'): ?>
                                        <h4 id="valida">Enviado</h4>
                                    <?php else: ?>
                                        <h4 id="valida">No Enviado</h4>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
    ...
    $(document).ready(function () {
        $('.update').click(function () {
            ...
            $.get(urll, function (data, status) {
                ...
                var validaST = $('#valida').text();
                if (validaST === "Enviado") {
                    $(".status").html('<input class="form-check-input" type="checkbox" name="status_embarque" value="enviado" id="enviar" checked> <label class="" for="">Enviar Embarque</label>');
                } else {
                    $(".status").html('<input class="form-check-input" type="checkbox" name="status_embarque" value="enviado" id="enviar" > <label class="" for="">Enviar Embarque </label>');
                }
