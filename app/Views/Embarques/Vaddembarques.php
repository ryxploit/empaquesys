                        ...
                        <div class="card-body ">
                            <div class="input-group">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingInput">numero de Pallet</label>
                                  </div>
                            </div>
                            <div class="input-group">
                                <div class="form-floating mb-3">
                                    <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com">
                                    <label for="floatingInput">peso de Pallet</label>
                                  </div>
                            </div>
                            <div class="input-group">
                                <div class="form-floating mb-3">
                                    <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com">
                                    <label for="floatingInput">Marca de Caja</label>
                                  </div>
                            </div>
                            <div class="input-group">
                                <div class="form-floating mb-3">
                    ...
                    <div class="card  col-5 " >
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                              ...
                              <div class="row">
                                <div class="col">
                                    <label for="inputEmail4" class="form-label">Chofer</label>
                                  <input type="text" class="form-control"  aria-label="First name">
                                </div>
                                <div class="col">
                                    <label for="exampleFormControlTextarea1" class="form-label">Destinatario</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col">
                                    <label for="inputEmail4" class="form-label">Numero de envio</label>
                                  <input type="text" class="form-control"  aria-label="First name">
                                </div>
                                <div class="col">
